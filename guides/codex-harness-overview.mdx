...
3. [Unified Runtime Host and App Server](/guides/codex-harness-runtime)
4. [Technical implementation of the Agent GUI](/guides/codex-harness-runtime#gui)
5. [Async tool calls and reasoning while executing](/guides/codex-harness-async)
6. [Mid-turn steering](/guides/codex-harness-async#steering)
7. [PTC, Code Mode, and MCP](/guides/codex-harness-code-mode)
8. [Compaction, window switching, and history retrieval](/guides/codex-harness-context-memory)
9. [Memory and dreaming](/guides/codex-harness-context-memory#memory)
10. [How post-training pairs with the harness](/guides/codex-harness-computer-use)
11. [Computer Use](/guides/codex-harness-computer-use#computer)
12. [Benchmarks and causal attribution](/guides/codex-harness-evaluation)
13. [Fair comparison with traditional harnesses and Claude](/guides/codex-harness-evaluation#comparison)
14. [Interview delivery and common follow-ups](/guides/codex-harness-evaluation#interview)
15. [Hands-on runs and acceptance](/guides/codex-harness-run)
16. [Source code navigation and references](/guides/codex-harness-sources)
17. [Full code appendix](/guides/codex-harness-code)
