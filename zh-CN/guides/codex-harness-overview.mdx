...
description: "从截图解读、公开证据一路走到可运行 Demo，建立 Agent Runtime 与 Harness 全景。"
---
...
1. [截图逐条核查](/zh-CN/guides/codex-harness-overview#claims)
2. [Harness 基础与分层](/zh-CN/guides/codex-harness-overview#foundations)
3. [统一 Runtime Host 与 App Server](/zh-CN/guides/codex-harness-runtime#3-统一-runtime-host-与-app-server-到底先进在哪里？)
4. [Agent GUI 的技术实现](/zh-CN/guides/codex-harness-runtime#4-agent-gui：看上去是界面，本质上是运行时状态的投影)
5. [异步工具调用与边执行边推理](/zh-CN/guides/codex-harness-async#5-异步工具调用：不是写一个-async-def-就实现了)
6. [Mid-turn steering](/zh-CN/guides/codex-harness-async#6-mid-turn-steering：运行中改需求，怎样保持一致性？)
7. [PTC、Code Mode 与 MCP](/zh-CN/guides/codex-harness-code-mode#7-ptc-/-code-mode：为什么让模型写代码来调用工具？)
8. [压缩、窗口切换、历史检索](/zh-CN/guides/codex-harness-context-memory#8-上下文管理：压缩、换窗口、检索不是一回事)
9. [Memory 与 dreaming](/zh-CN/guides/codex-harness-context-memory#9-memory-与-dreaming：agent-如何从过去的工作中积累经验？)
10. [模型后训练与 Harness 协同](/zh-CN/guides/codex-harness-computer-use#10-后训练如何与-harness-配合？哪些能讲，哪些不能编？)
11. [Computer Use](/zh-CN/guides/codex-harness-computer-use#11-computer-use：从"会点鼠标"到可靠的环境闭环)
12. [Benchmark 与因果归因](/zh-CN/guides/codex-harness-evaluation#12-benchmark：为什么"成绩好"不能直接证明-harness-最强？)
13. [与传统 Harness、Claude 的公平对比](/zh-CN/guides/codex-harness-evaluation#13-与传统-harness、claude-的公平对比)
14. [面试表达与高频追问](/zh-CN/guides/codex-harness-evaluation#14-面试表达：怎么把这些内容讲得具体而可信？)
15. [动手运行与验收](/zh-CN/guides/codex-harness-run#15-动手运行：先验证机制，再接真实模型)
16. [源码导航与资料](/zh-CN/guides/codex-harness-sources#16-公开资料与源码阅读顺序)
17. [完整代码附录](/zh-CN/guides/codex-harness-code#17-完整代码附录)
